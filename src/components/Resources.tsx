    ...
    return (
        <div className="bg-white">
            ...
            <div className="max-w-4xl mx-auto px-4 lg:px-8 py-14 space-y-12">
                ...
                <section>
                    ...
                    <div className="card-static p-6">
                        <ol className="space-y-3">
                            {[
                                <>Each team can have up to <strong>4 members</strong> with one designated captain.</>,
                ...
                <section>
                    <h2 className="section-heading text-2xl mb-5">📅 Model Upload Schedule</h2>
                    <p className="text-gray-500 text-sm mb-4">
                        You can upload or update your model only during the scheduled upload windows below.
                        Each window opens at <strong>12:00 AM IST</strong> and closes at the listed deadline time.
                    </p>
                    <UploadTimeline compact={true} />
                </section>
